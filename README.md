...
|                                                           프로젝트 총괄<br/> 커뮤니티                                                           |                                                                     채팅, 배포                                                                     | ElasticSearch 인기 검색어 추천, 자동완성, 검색<br />Kafka <br />MSA <br /> 멀티 모듈 <br /> ELK 기반 Log 관리 | Order, Bill, Payments 테이블 관리<br /> 결제흐름 구현 <br /> 재고관리(Redis 분산락, 비관적락) <br /> 중복결제 생성 개선(Redis Listener TTL발생) <br /> 결제승인 재시도 기능 |                                                               스프링 시큐리티                                                               |
